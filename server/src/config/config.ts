...
const envVarsSchema = Joi.object()
  .keys({
    MONGODB_URL: Joi.string()
      .required()
      .messages({ "any.required": "Provide Mongodb Url" }),
    OPEN_AI_KEY: Joi.string()
      .required()
      .messages({ "any.required": "Provide OpenAI key." }),
    CLOUDINARY_CLOUD_NAME: Joi.string()
      .required()
      .messages({ "any.required": "Provide cloudinaty cloud name" }),
    CLOUDINARY_API_KEY: Joi.string()
      .required()
      .messages({ "any.required": "Provide cloudinary api key" }),
    CLOUDINARY_API_SECRET: Joi.string()
      .required()
      .messages({ "any.required": "Provide cloudinary api secret." }),
  })
  .unknown();
